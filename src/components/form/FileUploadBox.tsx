...
const FileUploadBox = ({ file , imageType , uploaded = ()=>{} , name="file" }: FileUploadBoxProps) => {
    ...
    <If condition={!isUploadCanceled && !isUploaded}>
      ...
      >
        ...
        <Stack flexGrow="1" gap="10px"  >
          ...
          >
            <Stack>
              ...
              <Text  textTransform="capitalize" color="gray.500"  >
                ...
                <FormattedMessage id={reformulateFileSize(file?.size ?? 0)?.unit} />
              </Text>
            </Stack>


            <Icon  
              cursor="pointer" width="26px" h="26px" viewBox="0 0 16 16" fill="none" stroke="gray.600"
              _hover={{
                stroke: "red.500"
              }} 
          ...
          <Progress value={completeProgress}  colorScheme="primary" w="100%"  borderRadius="xl"  />
        </Stack>
