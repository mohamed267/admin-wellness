...
const SocialMediaAccount = ({ account , type , children }: PropsWithChildren<SocialMediaAccountProps>) => {
  return (
    <HStack position={"relative"} boxShadow="1px 1px 4px 0px #e2e2e2" bg="white" p={3} borderRadius="xl" spacing={3} >
