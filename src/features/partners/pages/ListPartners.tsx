...
import { Breadcrumb, BreadcrumbItem, Button, HStack, Icon, Menu, MenuButton, MenuItem, MenuList, Popover, PopoverTrigger, Stack, Text } from '@chakra-ui/react'
          ...
          <Menu>
            <MenuButton
              //  color="primary.500"
               ...
               as={Button}
               variant="whiteFill"
               rightIcon={<Icon fill="none" viewBox='0 0 12 8' stroke="gray.500" > <ChevronDown /> </Icon>}
            >

              <Text  _firstLetter={{ textTransform: "capitalize" }} textAlign="start" >
