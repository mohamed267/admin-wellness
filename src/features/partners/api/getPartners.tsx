...
export const getPartners = async ({ filterBy = "all" , ...query }: getPartnersQueryType): Promise<PartnerProps> => {
  ...
  const partners  = extractPartners(partnersResponse?.users as PartnerResponse[])
